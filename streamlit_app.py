...
def main():
    ...
    #Fifth page
        ...
        st.title("Conclusion")
        st.markdown("#### We have evaluated all three type of bussinesses on following points and Restaurant business was better than others:")
        st.markdown("#### Restaurant making more profit than others with 59065 pounds while  hotel 18795 pound and pub 30195 pound")
        st.markdown("#### Average rating  of restaurants among customers higher than 4 (max rating is 5), for pub and hotel lower than 4")
        st.markdown("#### Restaurants have more reviews than others")
